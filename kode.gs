...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & teks utama menggunakan Hitam Muda / Charcoal (#333333) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #333333}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#333333;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#333333;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#444444;margin:22px 0 8px}' +
    /* Background info box menggunakan warna abu-abu sangat muda (#F9F9F9) */
    '.info-box{background:#F9F9F9;border:1px solid #E0E0E0;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Hitam Muda (#333333) */
    '.paket-box{background:#333333;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan */
    '.syarat-box{background:#FAFAFA;border:1px solid #E5E5E5;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan dengan warna soft charcoal (#F4F4F4) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#F4F4F4;border:1px solid #DDDDDD;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#222222;letter-spacing:.04em}' +
